    ...
    return (
        <div>
            ...
            <Card className={cx(classes.selected)}>
                ...
                >
                    <Grid
                        className={(posts) ? cx(classes.active) : cx(classes.deactivate)}
                    >
                        <Typography>
                            <Button
                                onClick={clickPosts}
                    ...
                    <Grid
                        className={(events) ? cx(classes.active) : cx(classes.deactivate)}
                    >
                        <Button onClick={clickEvents}>
                            <Typography
                                fontWeight="bold" >
                                E<span
                                    className={cx(classes.logoColor)}>V</span>
                            </Typography>
                        </Button>
                    </Grid>
                    <Grid
                        className={(mark) ? cx(classes.active) : cx(classes.deactivate)}
                    >
                        <Typography>
